                                                        ...
                                                        <div class="tab-content" style="margin-right: auto; margin-left: auto;margin-top: -1.5%">
                                                            ...
                                                            <div class="tab-pane fade" id="Procedimiento" role="tabpanel">                                                              
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6" style="margin-left:auto;margin-right:auto ">                                                                           
                                                                        <div class="input-group input-group-lg mb-3">         
                                                                            <span class="input-group-text">N° Atención</span>
                                                                            <input type="text" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6" style="margin-left:auto;margin-right:auto ">
                                                            ...
                                                            <div class="tab-pane fade" id="Evolución" role="tabpanel">                                                                
                                                                <div class="row"> 
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <h5 class="card-title mb-0">Notas de Evolución</h5>
                                                                        <hr />
                                                                        <div class="clearfix">
                                                                            <div id="EditEvolución">
                                                                                <span class="ql-formats">
                                                                                    <select class="ql-font"></select>
                                                                                    <select class="ql-size"></select>
                                                                                </span>
                    ...
                    <div class="modal-body m-3">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <div class="input-group">                    
                                        <div class="input-group-text btn-primary">N° Atención</div>     
                                        <input type="text" class="form-control"/>                                                                           
                                    </div>                                                             
                                </div>                                                   
                            </div> 
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <div class="input-group">                    
                                        <div class="input-group-text btn-primary">Fecha de Atención</div>     
                                        <input type="date" class="form-control"/>                                                                           
                                    </div>                                                             
                                </div>                                                   
                            </div> 
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        if (!window.Quill) {
            return $("#quill-editor1,#quill-editor,#EditProcedimiento,#EditEvolución,#quilEvolución,#quilProcedimiento,#quill-toolbar1,#quill-toolbar").remove();
        }
        //Evolución
        ...
        var editor = new Quill("#quilEvolución", {
            modules: {
                toolbar: "#EditEvolución"
            },
            placeholder: "Datos de Evolución",
            theme: "snow"
        });
    });
</script>
