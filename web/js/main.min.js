...
var FullCalendar = function (e) {
    ...
    function C(e, t, n, r, o, i, a, s, l, u) {
        ...
        for (n.__k = [], p = 0; p < t.length; p++)
            if (null != (v = n.__k[p] = null == (v = t[p]) || "boolean" == typeof v ? null : "string" == typeof v || "number" == typeof v || "bigint" == typeof v ? g(null, v, null, null, v) : Array.isArray(v) ? g(m, {
                ...
                if (v.__ = n, v.__b = n.__b + 1, null === (h = D[p]) || h && v.key == h.key && v.type === h.type)
                    D[p] = void 0;
                else
                    for (f = 0; f < C; f++) {
    ...
    function k(e, t, n, r, o) {
        ...
        e: if ("style" === t)
            ...
            i = t !== (t = t.replace(/Capture$/, "")), t = t.toLowerCase() in e ? t.toLowerCase().slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + i] = n, n ? r || e.addEventListener(t, i ? M : x, i) : e.removeEventListener(t, i ? M : x, i);
    ...
    function I(e, t, n, r, o, a, s, l, u) {
        ...
        try {
            e: if ("function" == typeof R) {
                ...
                null == a && t.__v === n.__v ? (t.__k = n.__k, t.__e = n.__e) : t.__e = N(n.__e, t, n, r, o, a, s, u);
            (c = i.diffed) && c(t)
        } catch (e) {
    ...
    function Hn(e, t, n, r, o) {
        ...
        if (u)
            return (c = Ln(a, s, t ? t.sourceId : "", u.allDay, Boolean(u.duration), n)).recurringDef = {
                typeId: u.typeId,
                typeData: u.typeData,
                duration: u.duration
            }, {
    ...
    var Wa = /^(visible|hidden)$/,
            Va = function (e) {
                ...
                return n(t, e), t.prototype.render = function () {
                    ...
                    if (Wa.test(this.props.overflowX))
                        return !1;
                    ...
                    if (Wa.test(this.props.overflowY))
                        return !1;
            ...
            As = function () {
                ...
                return e.prototype.destroy = function () {
                    ...
                    for (var n, r, o = {
                        ...
                        var s = a[i];
                        if (n = s.getEventTarget(), r = void 0, "HTML" !== (r = n.tagName) && "BODY" !== r && !Zr(o, s.clientRect))
                            return !1
                    }
                    return !0
                }, e
    ...
    }, e.triggerDateSelect = mr, e.unmountComponentAtNode = No, e.unpromisify = yo, e.version = "5.11.0", e.whenTransitionDone = Ne, e.wholeDivideDurations = Wt, Object.defineProperty(e, "__esModule", {
        value: !0
    }), e
}({});